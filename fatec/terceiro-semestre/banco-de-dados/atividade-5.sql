...
VALUES ('12345/SP', 'Dr. João Silva');
INSERT INTO medico (crm, nome)
VALUES ('67890/RJ', 'Dra. Ana Costa');
INSERT INTO medico (crm, nome)
VALUES ('11223/MG', 'Dr. Pedro Santos');
...
INSERT INTO consulta (diagnostico, dia_hora)
VALUES (
...
INSERT INTO exame (nome, valor)
VALUES ('Hemograma completo', 85.50);
INSERT INTO exame (nome, valor)
VALUES ('Eletrocardiograma', 120.00);
INSERT INTO exame (nome, valor)
VALUES ('Teste de Alergia', 210.30);
UPDATE exame
...
VALUES ('Carlos Oliveira', '11122233344');
INSERT INTO paciente (nome, cpf)
VALUES ('Mariana Souza', '55566677788');
INSERT INTO paciente (nome, cpf)
VALUES ('Felipe Almeida', '99900011122');
...
INSERT INTO convenio (nome, titulo, validade, tipo)
VALUES (
        'Saúde Mais',
        'Plano Ouro',
        '2027-12-31 00:00:00',
...
WHERE C.dia_hora BETWEEN '2014-05-01 00:00:00' AND '2014-05-31 23:59:59';
SELECT COUNT(C.numero) AS Total_Consultas
FROM consulta C
...
SELECT Nome_Paciente,
    Nome_Medico
FROM vw_consulta_medico_paciente
WHERE dia_hora >= '2014-05-01'
    AND dia_hora < '2014-06-01';
CREATE VIEW vw_consulta_convenio AS
SELECT C.numero AS Codigo_Consulta,
    C.dia_hora,
    Co.nome AS Nome_Convenio
FROM consulta C
    JOIN convenio Co ON C.codigo_convenio = Co.codigo;
SELECT COUNT(Codigo_Consulta) AS Total_Consultas_Amil
FROM vw_consulta_convenio
WHERE Nome_Convenio = 'Amil'
...
CREATE VIEW vw_atendimentos_especialidade AS
SELECT C.numero AS Codigo_Consulta,
    C.dia_hora,
...
FROM vw_atendimentos_especialidade
WHERE dia_hora >= '2014-01-01'
    AND dia_hora < '2014-07-01'
GROUP BY Nome_Especialidade
ORDER BY Quantidade_Atendimentos DESC;
CREATE VIEW vw_exames_por_medico AS
SELECT E.nome AS Nome_do_Exame,
    C.dia_hora,
    M.nome AS Nome_Medico
FROM exame E
    JOIN consulta_exame CE ON E.codigo = CE.codigo_exame
    JOIN consulta C ON CE.numero_consulta = C.numero
    JOIN medico M ON C.crm_medico = M.crm;
SELECT DISTINCT Nome_do_Exame
FROM vw_exames_por_medico
WHERE Nome_Medico = 'Dr. Eduardo'
    AND dia_hora BETWEEN '2014-03-15 00:00:00' AND '2014-03-30 23:59:59';
CREATE TABLE paciente2 (
    codigo INT PRIMARY KEY,
    nome VARCHAR(200) NOT NULL
);
INSERT INTO paciente2 (codigo, nome)
SELECT codigo,
    nome
FROM paciente;
SELECT *
